...
def test_request_fingerprint_is_stable_for_equivalent_json_objects() -> None:
    left = request_fingerprint({"cnj": "0000000-00.0000.0.00.0000", "format": "json", "force": True})
    right = request_fingerprint({"force": True, "format": "json", "cnj": "0000000-00.0000.0.00.0000"})
    if left != right:
