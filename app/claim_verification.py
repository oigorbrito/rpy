...
# Cache compiled regex patterns for party names to avoid re-compiling dynamic regexes
# on every document/claim verification step (~1.25x performance improvement on claim verification).
